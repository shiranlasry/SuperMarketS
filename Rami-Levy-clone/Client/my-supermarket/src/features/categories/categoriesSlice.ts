...
export const foodCategoriesSelector = (state: RootState) =>
  state.categories.foodCategories;
export const subFoodCategoriesSelector = (state: RootState) =>
  state.categories.subFoodCategories;
