    ...
    return (
        <div className="login-main">
            ...
            <div className="go-to-reg">
                <button className="registration" onClick={() => setIsRegisterPressed(true)}>
                ...
                <button className="firs-time-reg" onClick={() => setIsRegisterPressed(true)}>
            ...
            </div>
            {
                isRegisterPressed &&
                <>
                    <Register onClose={() => setIsRegisterPressed(false)} />
                </>
            }
        </div>
    );
