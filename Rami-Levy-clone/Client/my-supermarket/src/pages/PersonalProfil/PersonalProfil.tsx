...
const PersonalProfil = () => {
  ...
  return (
    ...
    <div className="Personal-profil-menu">
        <button onClick={()=>{setAllFalse();setShowUserDetails(true)}}>פרטים אישיים</button>
        <button onClick={()=>{setAllFalse();setShowUserAddress(true)}}>ניהול כתובות</button>
        <button>תשלום</button>
    ...
    <div className="Personal-profil-lists">
