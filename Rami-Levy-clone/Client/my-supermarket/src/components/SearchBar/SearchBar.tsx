    ...
    <div className="search-bar">
      <div className="search-input-container"> {/* Input field for search */}
        ...
        <svg
          ...
          width="21.1"
          height="17"
          viewBox="0 0 22.58 18.33"
          className="filter-svg"
        >
          <defs data-v-dce8ddf8="">
            <clipPath
              data-v-dce8ddf8=""
              id="a"
              transform="translate(-5.71 -7.83)"
            >
              <rect
                data-v-dce8ddf8=""
                width="34"
