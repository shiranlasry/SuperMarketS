...
interface SubCatagoryManuProps {
  ...
  const SubCatagoryManu: React.FC<SubCatagoryManuProps> = ({ navbar_item_id }) => {
    ...
    const filteredCategories = subFoodCategories?.filter(item => item.navbar_item_id === navbar_item_id) || [];
